...
def check_autostep(option, opt, value):
    ...
    try:
        ...
        if value == "auto":
            return value
        error_fmt = (
            "option %s: invalid value: %r, should be node count, "
...
class OptionParser(optparse.OptionParser):
    ...
    def install_nodeset_operations(self):
        ...
        optgrp.add_option(
            ...
            default=[],
            type="string",
            help="calculate symmetric difference between nodesets",
        )
        self.add_option_group(optgrp)
    ...
    def install_nodeset_options(self):
        ...
        optgrp.add_option(
            ...
            action="store_true",
            dest="all",
            help="call external node groups support to display all nodes",
        )
        optgrp.add_option(
            "--autostep",
            action="store",
        ...
        optgrp.add_option(
            ...
            action="store_true",
            dest="rangeset",
            help="switch to RangeSet instead "
